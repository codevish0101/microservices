package com.codevish.accounts.controller;
...
import com.codevish.accounts.dto.ErrorResponseDto;
import com.codevish.accounts.dto.ResponseDto;
...
public class AccountsController {
    ...
    @Operation(
         ...
         description = "REST API to create new Customer &  Account inside CodeVish",
         responses = {
                 @ApiResponse(
                         responseCode = "201",
    ...
    public ResponseEntity<ResponseDto> updateAccountDetails(@Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits") @RequestParam String mobileNumber) {
